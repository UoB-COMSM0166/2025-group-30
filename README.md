...
| **Includes / Extensions** | Perfect Stack (if balanced precisely)                                           | Resume, Restart, Exit                                                                                    | Move Left/Right, Stack Hay, Empty to Barrel, Avoid Obstacles, Catch Special Items            |
